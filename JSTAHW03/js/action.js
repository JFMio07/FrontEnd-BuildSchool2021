...
function RenderCalendar(srcdate, srcdatelist) {
  ...
  let a = srcdate.getFullYear();
  let b = srcdate.getDate();

  let a1 = currentDate.getFullYear();
  let b1 = currentDate.getDate();
